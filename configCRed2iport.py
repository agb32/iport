...
cameraParams[4*ncam:5*ncam]=640#npxlx
cameraParams[5*ncam:6*ncam]=512#npxly
...
cameraParams[9*ncam+1:10*ncam+1]=0xffffffff#0xfc0fc0#affinity
...
ab=numpy.array([2*640,2*512]).astype("i")	#.byteswap()
camCommand="ImageWidth=%d;ImageHeight=%d;TestPattern=Off;GevStreamThroughputLimit=1075773440;R[0x0d04]=8164;R[0x12650]=7;Bulk0Mode=UART;R[0x20017814]=6;BulkNumOfStopBits=One;BulkParity=None;BulkLoopback=false;EventNotification=Off;"%(ab[0],ab[1])
