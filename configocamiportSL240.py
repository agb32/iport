...
#This one tests the libcamSL240Aravis.so library - but without any aravis cameras.
...
cameraParams=numpy.zeros((17+(namelen+3)//4,),numpy.int32)


cameraParams[0]=1#affin el size
cameraParams[1]=0#ncamSL240
cameraParams[2]=16#bits per pixel - though aravis should be told it is 8 bpp for OCAM.
cameraParams[3]=65536#block size
cameraParams[4]=0#offset x
cameraParams[5]=0#offset y
cameraParams[6]=1056#camnpxlx
cameraParams[7]=121#camnpxly
cameraParams[8]=1#byteswap Ints
cameraParams[9]=4#reorder
cameraParams[10]=50#priority
cameraParams[11]=0xfc0fc0#affinity
cameraParams[12]=2#skipFrameAfterBad
cameraParams[13]=0#pxlRowStartSkipThreshold
cameraParams[14]=0#pxlRowEndInsertThreshold
cameraParams[15]=0#recordTimestamp
cameraParams[16]=namelen#number of bytes for the name.
cameraParams[17:17+(namelen+3)//4].view("c")[:]=camNames
